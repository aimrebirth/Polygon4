...
void FDBToolCommands::RegisterCommands()
{
    ...
    //
    UI_COMMAND(ImportAndFixPathToResource, "Import And Fix Path To Resource", "Import And Fix Path To Resource", EUserInterfaceActionType::Button, FInputGesture());
    //
    ...
    //
    UI_COMMAND(GenerateFoliageInstancesFromDB, "Generate Foliage Instances from DB", "Generate Foliage Instances from DB", EUserInterfaceActionType::Button, FInputGesture());
    UI_COMMAND(DestroyAllFoliageInstances, "Destroy All Foliage Instances", "Destroy All Foliage Instances", EUserInterfaceActionType::Button, FInputGesture());
    //
